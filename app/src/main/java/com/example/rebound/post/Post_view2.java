...
public class Post_view2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Post_view2.this));
...
//                String id = jsonObject.getString("id");
        ...
        String Nreply = sharedPreferences.getString(date, "");
        try {
            JSONArray jsonArray = new JSONArray(Nreply);
...
//        }
    ...
    protected void onPause() {
        ...
        try {
            ...
            String Nreply = jsonArray.toString();
            SharedPreferences sharedPreferences;
            sharedPreferences = getSharedPreferences("News_rcv", MODE_PRIVATE);
            SharedPreferences.Editor editor;
            editor = sharedPreferences.edit();
            editor.putString(date, Nreply);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
