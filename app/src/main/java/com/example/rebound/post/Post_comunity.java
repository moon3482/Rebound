        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (titleText.length() == 0) {
                    Toast.makeText(Post_comunity.this, "제목을 입력해주십쇼", Toast.LENGTH_SHORT).show();
                } else if (contentText.length() == 0) {
                    Toast.makeText(Post_comunity.this, "내용을 입력해주십쇼", Toast.LENGTH_SHORT).show();
