...
public class Post_View extends AppCompatActivity implements OnMapReadyCallback {
...
//        String userid2 = intent.getStringExtra("id");
       ...
       int kk = 0;
//        for(int i = 0; i<setuser.length(); i++){
//            String[] getuserid = userprofile[i].split("-");
//            if(userid2.equals(getuserid[0])){
//                kk = i;
//                return;
//            }
//            return;
//        }
        final String[] userpofile3 = userprofile[kk].split("-");
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Post_View.this));
            ...
            public void onClick(View view) {
                if (id.equals(LoginActivity.user_id)) {
                    ...
                    if (sub_rcv == false) {
                        ...
                        Post_Data2 post_data2 = new Post_Data2("", "", "", "", id1, "", "", "", bri1, "", pho1, pho2, pho3, ema1, ema2, hei1, wei1, team, "", posi, "", userprofile2[17], "0");
                        arrayList.add(post_data2);
                        subscription_adapter.notifyDataSetChanged();
                    }
...
//    }
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        Geocoder geocoder = new Geocoder(Post_View.this, Locale.KOREA);
...
//                        Log.e("좌표주소", list.get(0).toString());
                ...
                infoWindow.setAdapter(new InfoWindow.DefaultTextAdapter(Post_View.this) {
                    @NonNull
                    @Override
            ...
            naverMap.setOnMapClickListener(new NaverMap.OnMapClickListener() {
                ...
                public void onMapClick(@NonNull PointF pointF, @NonNull LatLng latLng) {
                    ...
                    if (list == null || list.isEmpty()) {
                        Post_View.this.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.nhn.android.nmap")));
                    } else {
                        Post_View.this.startActivity(intent);
                    }
                }
            });
