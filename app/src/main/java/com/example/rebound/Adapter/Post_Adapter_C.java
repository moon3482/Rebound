...
import com.example.rebound.post.Post_view2_comu;
import com.example.rebound.R;

import java.util.ArrayList;

public class Post_Adapter_C extends RecyclerView.Adapter<Post_Adapter_C.CustomViewHolder> {
    private ArrayList<Post_Data_NC> arrayList;
    private ArrayList<Post_Data_NC> unarrayList;
    Post_Adapter_C.CustomViewHolder holder;
...
private Context context;
    ...
    private Post_Adapter_C.OnItemCliclistener mListener = null;

    public void setOnItemCliklistener(Post_Adapter_C.OnItemCliclistener listener) {
...
//////////////////////////////////////////////////////////////////여기부터 중요
    ...
    public Post_Adapter_C(ArrayList<Post_Data_NC> item) {
        arrayList = item;
    ...
    @NonNull
    @Override
    public Post_Adapter_C.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rclv_item, parent, false);
        Log.i("데이터", "onCreateView");
        holder = new Post_Adapter_C.CustomViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull Post_Adapter_C.CustomViewHolder holder, final int position) {
...
//        holder.content.setText(post_data_nc.getContent());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Post_view2_comu.class);
