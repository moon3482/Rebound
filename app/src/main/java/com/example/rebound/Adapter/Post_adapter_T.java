...
import com.example.rebound.post.Post_View_Team;
...
public class Post_adapter_T extends RecyclerView.Adapter<Post_adapter_T.CustomViewHolder> {
    LoginActivity loginActivity;
    String button;
    private ArrayList<Post_Data> arrayList;
    private ArrayList<Post_Data> unarrayList;
    Post_adapter_T.CustomViewHolder holder;
    ...
    private Post_adapter_T.OnItemClickListener mListener = null;
...
//////////////////////////////////////////////////////////////////여기부터 중요
    ...
    public Post_adapter_T(ArrayList<Post_Data> arrayList) {
    ...
    @NonNull
    @Override
    public Post_adapter_T.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rclv_item, parent, false);
        Log.i("데이터", "onCreateView");
        Log.i("아아아아아", arrayList.get(0).getId());

        holder = new Post_adapter_T.CustomViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull Post_adapter_T.CustomViewHolder holder, final int position) {
...
//        holder.content.setText(post_data.getContent());
        ...
        Log.i("뷰클릭 오잉", arrayList.get(position).getId());
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("수정", editdate);
                Intent intent = new Intent(view.getContext(), Post_Team.class);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Post_View_Team.class);
